...
target_link_libraries(perastage_inspection_validation PUBLIC perastage_inspection_core PRIVATE LibXml2::LibXml2 )
...
target_link_libraries(perastage_inspection_gdtf PUBLIC perastage_inspection_core perastage_inspection_package perastage_inspection_validation perastage_gdtf_read PRIVATE perastage_inspection_gdtf_byte_source )
target_link_libraries(perastage_inspection_resource PUBLIC perastage_inspection_core perastage_inspection_package PRIVATE perastage_archive_zip_directory perastage_archive_zip_entry_reader perastage_gdtf_read perastage_inspection_gdtf_byte_source )
