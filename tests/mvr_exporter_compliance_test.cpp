...
int main() {
  ...
  fs::create_directories(tempDir / "library");
  cfg.SetValue("fixtures_dictionary_active_path",
               (tempDir / "library" / "gdtf_dictionary.json").generic_string());
  ...
  std::ofstream(tempDir / "library" / "@PerastageFixture.gdtf") << "AT";
