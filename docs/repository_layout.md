...
This page provides a concise map of the main Perastage repository areas. For the broader high-level tree, see the root-level `perastage_tree.md` file. For architectural boundaries and contribution rules, see [Architecture](architecture.md).
...
| `perastage_tree.md` | Root-level high-level repository map used by architecture guard scripts. |
