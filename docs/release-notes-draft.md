...
- Added a secure, persistent dependency cache for trusted GitHub Actions builds while retaining fast local workflow caches and read-only behavior for CI and installers.
