...
- Separated reusable 3D manipulation, continuous-placement, line-point selection, and measurement session state from the wxWidgets/OpenGL panel while preserving existing viewport behavior.
