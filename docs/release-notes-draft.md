...
- Restored the Perastage v1.3.0 3D fixture hover path so fixture highlighting uses the same fast culling and proxy/instanced rendering behavior that kept hover feedback responsive.
