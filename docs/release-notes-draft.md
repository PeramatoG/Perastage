...
- Encapsulated reusable 3D manipulation, continuous-placement, line-point selection, and measurement session state outside the wxWidgets/OpenGL panel while preserving existing viewport behavior.
