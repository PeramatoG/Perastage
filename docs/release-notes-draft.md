...
- **Hoist load editing feedback** - manually entered hoist loads and automatic loads based on missing weight data are again shown in red, and the Load context menu now provides an explicit option to restore and recalculate the automatic value.
