...
- Fixed 3D fixture hover highlighting and edge clipping so fixtures stay visible at viewport edges while hover picking follows the proven v1.3.0 interaction path.
