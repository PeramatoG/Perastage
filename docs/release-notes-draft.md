...
- Corrected read-only MVR inspection for recovered node identities, duplicate layer names, authored direct-child hierarchy, nested groups, and complete deterministic Symdef resource inventories without changing imported scene data.
