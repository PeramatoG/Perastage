...
- Separated logical MVR scene-node and hierarchy reading from importer orchestration while preserving existing fixture, rigging, geometry, layer, and compatibility behavior.
