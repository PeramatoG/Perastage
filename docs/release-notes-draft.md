...
## Fixes
- Improved MVR compatibility by preserving Support objects during roundtrip export, using placeholder geometry for otherwise empty SceneObject exports, and writing Truss children in schema-compatible order.
