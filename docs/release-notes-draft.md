...
- Refined Fixture Edit DMX inspection with a wrapped, card-style presentation and resolution-matched slider ranges, so exact DMX values, percentages, and active function or set ranges stay readable and aligned with the selected channel.
