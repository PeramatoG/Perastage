...
- Encapsulated reusable 3D manipulation, continuous-placement, line-point selection, and measurement session state behind guarded GUI-independent boundaries while preserving existing viewport behavior.
