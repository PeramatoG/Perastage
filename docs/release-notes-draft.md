...
- Fixed 3D fixture hover highlighting and edge clipping so fixtures remain visible and responsive at viewport edges while highlight changes repaint reliably.
