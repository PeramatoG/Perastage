...
- Fixed dictionary reset and layer service UTF-8 test targets so app paths, layout package, runtime storage, and ConfigManager layer-selection stubs link during full rebuilds.
