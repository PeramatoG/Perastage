...
## Internal changes
- Centralized wxGLCanvas attribute selection, OpenGL context binding diagnostics, and GLEW initialization helpers across the 3D, 2D, Layout, and Fixture Preview panels.
