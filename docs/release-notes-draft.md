...
- Added a read-only hierarchical GDTF mode and channel browser with DMX ranges, physical ranges, units, details, parser diagnostics, cached source loading, a quick channel summary below Physical properties, and readable channel names in the browser for Fixture Edit.
