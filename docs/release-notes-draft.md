...
- Fixed 3D fixture hover highlighting and edge clipping so fixtures stay visible at viewport edges without slowing fixture hover picking in 2D or 3D views.
