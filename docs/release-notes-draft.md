...
- Restored v1.3.0-style 3D fixture hover picking, labels, and selection highlighting during fast viewport interaction, especially for dense GDTF fixture models.
