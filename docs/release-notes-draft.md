...
- Corrected read-only MVR inspection for duplicate layer names, authored direct-child hierarchy, nested groups, and deterministic Symdef resource inventories without changing imported scene data.
