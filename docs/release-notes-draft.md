...
- Added a GUI-independent, read-only package inventory boundary for supported GDTF and MVR files, including Unicode-preserving entry metadata and safe rejection of traversal-style archive paths without extracting or importing package contents.
