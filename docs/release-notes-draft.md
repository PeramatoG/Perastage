...
- Added a deterministic, versioned JSON boundary for neutral inspection results, enabling future automation without coupling inspection semantics to command-line or graphical presentation.
