...
- Swapped Data Views table mouse behavior so left double-click now opens cell-editing actions, while right-click opens row-level edit dialogs such as Edit Fixture, Edit Truss, and primitive object editors.
