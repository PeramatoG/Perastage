...
- Fixed 3D fixture hover highlighting and edge clipping so fixtures stay visible at viewport edges and hover highlights and labels track mouse movement immediately across fixtures.
