...
- Fixed a macOS 3D viewer rendering regression where hover highlights could leave OpenGL state behind and cause model faces to disappear until the affected fixture changed; macOS and Intel OpenGL drivers now use the safer ray-based hover picking path.
