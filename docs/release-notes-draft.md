...
- Refined Fixture Edit DMX inspection so the slider shows only the exact resolution-aware DMX value, percentage, and active function or set range for the selected channel.
