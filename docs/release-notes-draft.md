...
- **Safer fixture table maintenance** - fixture table columns now use centralized named identities and validated index conversion, reducing the risk of editing, rendering or scene-update regressions when the table evolves.
