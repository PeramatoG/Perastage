...
- Added secure compiler-cache acceleration and measurable cache diagnostics to trusted and pull-request Debug CI builds without changing installer, dependency-cache, or test behavior.
