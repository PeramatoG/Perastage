...
- **Imported MVR GDTF saving** - projects created from imported MVR files now keep embedded GDTF resources resolvable during save even when canonical export naming rewrites the final `.gdtf` archive names.
