...
- Finalized secure credential-storage release gates by unifying Windows vcpkg manifest installs, adding focused credential tests to CI, and documenting Windows Credential Manager validation.
