...
- Restored fast 3D fixture hover highlighting by using the same proxy/instanced fast-interaction path as Perastage v1.3.0 while preserving responsive viewport-edge repaint behavior.
