...
- Fixed truss weight edits from the Edit Truss dialog so type synchronization and hoist-load recalculation use the newly applied truss weight on the first attempt.
