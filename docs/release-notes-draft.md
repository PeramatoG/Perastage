...
- Refined Fixture Edit DMX inspection with a wrapped, card-style presentation that shows the exact resolution-aware DMX value, percentage, and active function or set range without truncating long names.
