# Windows bootstrap implementation for validating and building the Windows Ninja workflow.
param(
...
$BootstrapModulePath = Join-Path $PSScriptRoot 'PerastageWindowsBootstrap.psm1'
