...
- Beam intensity range: `beam_multiplier` supports `0.0 .. 80.0` with default `20.0`. The first `0..20` span preserves previous visual calibration, while `20..80` adds overdrive headroom for large scenes.
