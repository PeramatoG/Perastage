...
const GOBO_SHADOW_BIAS: float = 0.0008
const GOBO_SHADOW_NORMAL_BIAS: float = 0.01
...
func _apply_gobo_alpha_quad(light: SpotLight3D, gobo_texture: Texture2D) -> void:
	...
	var quad_distance: float = clamp(beam_range * GOBO_QUAD_DISTANCE_RATIO_OF_RANGE, GOBO_QUAD_MIN_DISTANCE_M, min(GOBO_QUAD_MAX_DISTANCE_M, beam_range * 0.45))
