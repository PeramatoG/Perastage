...
const GOBO_SHADOW_COOKIE_SHADOW_NORMAL_BIAS: float = 0.15
const GOBO_SHADOW_COOKIE_SHADOW_BLUR: float = 0.08
const GOBO_SHADOW_COOKIE_MESH_BEAM_INTENSITY_MULTIPLIER: float = 0.45
