...
placeholders. PDF parsing uses PoDoFo and falls back to the `pdftotext` command
when available for better compatibility. The application will populate tables with fixtures and trusses
