...
ExportObjectDialog::ExportObjectDialog(wxWindow* parent, const std::vector<std::string>& names)
    : wxDialog(parent, wxID_ANY, "Export Object", wxDefaultPosition, wxDefaultSize)
{
...
std::string ExportObjectDialog::GetSelectedName() const
{
