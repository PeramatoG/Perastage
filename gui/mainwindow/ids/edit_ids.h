...
constexpr int ID_Edit_AddSpherePrimitive = ID_Edit_AddSceneObject + 1;
constexpr int ID_Edit_AddCubePrimitive = ID_Edit_AddSpherePrimitive + 1;
constexpr int ID_Edit_Delete = ID_Edit_AddCubePrimitive + 1;
