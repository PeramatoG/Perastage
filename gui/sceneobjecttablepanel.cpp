    ...
    : wxPanel(parent, wxID_ANY)
{
    ...
    table->Bind(wxEVT_DATAVIEW_COLUMN_HEADER_CLICK,
                &SceneObjectTablePanel::OnColumnHeaderClick, this);
...
void SceneObjectTablePanel::OnColumnHeaderClick(wxDataViewEvent& event)
{
...
void SceneObjectTablePanel::ApplySort()
{
...
void SceneObjectTablePanel::UpdateColumnHeaders()
{
