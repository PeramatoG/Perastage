...
// Reads logical MVR scene nodes and preserves layer and group hierarchy.
inline void ReadMvrSceneNodes(
    tinyxml2::XMLElement *sceneNode, MvrScene &scene,
    MvrImportResult &importResult, const MvrImportOptions &options,
    auto &fixtureUuidRemap, auto &textOf, auto &intOf, auto &fixtureIdOf,
    auto &parseMatrixOrIdentity, auto &remapArchivePathIfNeeded,
    auto &buildFixtureTypeInfoKey, auto &resolveStableUuid,
    auto &referenceUuidForNode, auto &ensurePositionEntry,
    auto &normalizeGdtfSpecForScene, auto &resolveGdtfPathCached,
    auto &getFixtureMetadata, auto &resolveExistingGdtfModeCached,
    auto &getGdtfModeChannelCountCached, auto &getDictionaryEntryCached,
    auto &loadTrussDefinitionCached, auto &resolveSymdefReference,
    auto &normalizeAndResolveGeometryFileName, auto &appendGeometryInstance,
    auto &reportProgress, auto &pendingGdtfConflictByType,
    auto &categoryByTypeKey, auto &categoryInferenceByResolvedPath,
    auto &rootFixtureTypeInfoByKey, auto &projectFixtureIdentifiersByUuid,
    auto &projectFixtureColorsByUuid, auto &projectFixtureColorMetadataUuids,
    auto &consumedProjectFixtureColorUuids, auto &rootTrussInfoByUuid,
    auto &consumedRootTrussInfoUuids, auto &rootHoistInfoByUuid,
    auto &consumedRootHoistInfoUuids, auto &perastageTypeToGdtfPath,
    auto &perastageInstanceToTypeKey,
    auto &rootPrimitiveModelRefsBySceneObjectAndFile,
    auto &legacyPositionIdToCanonical, auto &layerColorByUuid,
    auto &layerColorByName, auto &isHexRgb,
    int &trussSymbolSymdefPreservedCount,
    auto &trussSymbolSymdefPreservedBySymdef, auto &parseChildList,
    int &preservedGroupObjectCount) {
        ...
        if (options.applyDictionary && dictionaryEntry &&
          ...
          pendingGdtfConflictByType.try_emplace(
              ...
              GdtfConflict{fixture.typeName, fixture.requestedFixtureName,
                           ...
                           resolvedFixtureTypeId, fixture.gdtfMode, footprint,
                           true});
        }
